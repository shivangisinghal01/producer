...
RUN dotnet ef database update --connection "Server=localhost;Database=Producer;User=sa;password=Shiv@angi1Sing;Persist Security info=True;TrustServerCertificate=True;"
