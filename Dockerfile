...
RUN dotnet ef database update --connection "Server=172.17.0.1,1433;Database=Producer;User=sa;password=Shiv@angi1Sing;Persist Security info=True;TrustServerCertificate=True;"
