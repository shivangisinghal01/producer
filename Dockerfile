...
RUN dotnet ef database update --connection "Server=mysql-1-9n7rh;Database=Producer;User=sa;password=Shiv@angi1Sing;Persist Security info=True;TrustServerCertificate=True;"
